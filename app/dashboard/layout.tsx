...
export default function DashboardLayout({
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      {/* Sidebar */}
      <aside className={`bg-indigo-800 text-white transition-all duration-300 ${sidebarOpen ? 'w-64' : 'w-20'}`}>
        {/* Logo */}
        <div className="flex items-center justify-between p-4 border-b border-indigo-700">
          {sidebarOpen && <h1 className="text-xl font-bold">DentalSaaS</h1>}
          <button 
          ...
          <div className="flex items-center gap-3">
            ...
            {sidebarOpen && (
              <div className="flex-1">
                <p className="text-sm font-semibold">Dr. Quispe</p>
